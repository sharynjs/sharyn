...
- [**between**](https://github.com/sharynjs/sharyn/tree/master/packages/util.between/README.md#readme) – Tests if a value is between two bounds
- [**cycle**](https://github.com/sharynjs/sharyn/tree/master/packages/util.cycle/README.md#readme) – Cycles between multiple values
...
- [**swit**](https://github.com/sharynjs/sharyn/tree/master/packages/util.swit/README.md#readme) – An inline and less verbose `switch`
- [**toggle**](https://github.com/sharynjs/sharyn/tree/master/packages/util.toggle/README.md#readme) – Toggles between two values
- [**tryCatch**](https://github.com/sharynjs/sharyn/tree/master/packages/util.trycatch/README.md#readme) – An inline `try` - `catch` - `finally`
- [**wait**](https://github.com/sharynjs/sharyn/tree/master/packages/util.wait/README.md#readme) – A `Promise`-based delay
